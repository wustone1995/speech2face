...
def main():
	...
	parser.add_argument("--from_id", type = int, default = 1)
	...
	parser.add_argument("--save_model", type = str, default = "model_directory")
	...
	audemb_model.train(train_ids,valid_ids,args.batchsize,args.save_model,start_epoch = 0, num_epoch = args.epochs, num_samples = args.num_samples )

	Test_Loss = audemb_model.test(test_ids, batchsize=args.batchsize, num_samples = 102 )
